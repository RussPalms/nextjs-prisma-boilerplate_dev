...
- check existing [Issues](https://github.com/russpalms/nextjs-prisma-boilerplate/issues) and [Roadmap](https://github.com/russpalms/nextjs-prisma-boilerplate#roadmap) and see if you can pick some of them
...
- instructions how to setup development environment you can find in [Development environment](https://github.com/russpalms/nextjs-prisma-boilerplate#development-environment) section
...
- when you finish implementation make sure that:
  ...
  - existing Jest (unit and integration) and Cypress e2e tests pass, more info: [Running tests](https://github.com/russpalms/nextjs-prisma-boilerplate#running-tests)
